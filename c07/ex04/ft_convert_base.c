...
/*   Updated: 2025/03/08 10:11:40 by abhaifou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//     // ✅ Basic Conversions
//     test_case("101", "01", "0123456789", "5"); 
//     test_case("-42", "0123456789", "01", "-101010"); 
//     test_case("2A", "0123456789ABCDEF", "0123456789", "42"); 
//     test_case("42", "0123456789", "0123456789ABCDEF", "2A"); 
//     test_case("177", "01234567", "0123456789", "127"); 
//     test_case("127", "0123456789", "01234567", "177"); 

//     // ✅ Handling Spaces and Signs
//     test_case("   -100", "0123456789", "01", "-1100100");
//     test_case("   +2A", "0123456789ABCDEF", "0123456789", "42"); 

//     // ✅ Large Numbers
//     test_case("ZZZ", "ABCDEFGHIJKLMNOPQRSTUVWXYZ", "0123456789", "17575");
//     test_case("123456789", "0123456789", "0123456789ABCDEF", "75BCD15"); 
...
//     // ✅ Invalid Inputs
//     test_case("invalid", "0123456789", "01", "NULL"); 
//     test_case("42", "0", "01", "NULL"); // Invalid base
//     test_case("42", "0123456789", "0123456789ABCDEF+", "NULL"); 
//     test_case("42", "0123456789", "01234 6789", "NULL"); 
